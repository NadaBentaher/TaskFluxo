...
<head>
  ...
  <base href="http://localhost/taskfluxo/public/">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= base_url('admin'); ?>" class="brand-link">
      ...
      <span class="brand-text font-weight-light">TaskFluxo</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <div class="dropdown-menu" aria-labelledby="employeeDropdown">
          ...
          <a class="dropdown-item" href="#">Manage Designations</a>
        </div>
      </li> -->
      <li class="nav-item">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="projectsDropdown">
          <a class="dropdown-item" href="<?= base_url('tasks'); ?>">Task Management</a>
          <a class="dropdown-item" href="<?= base_url('projects'); ?>">Project Management</a>
        </div>
      </li>
        </ul>
      </nav>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <!-- <strong>Copyright &copy; 2014-2021 <a href="<?=base_url(); ?>">taskfluxo.io</a>.</strong> All rights reserved. -->
  </footer>
</div>
<!-- ./wrapper -->
